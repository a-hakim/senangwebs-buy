(()=>{var F=(L,u)=>()=>(u||L((u={exports:{}}).exports,u),u.exports);var N=F((C,A)=>{(function(u,k){typeof C=="object"&&typeof A=="object"?A.exports=k():typeof define=="function"&&define.amd?define([],k):typeof C=="object"?C.SWB=k():u.SWB=k()})(C,()=>(()=>{var L={64:(function(v){(function(h,c){v.exports=c()})(this,()=>(()=>{"use strict";var h={d:(M,p)=>{for(var f in p)h.o(p,f)&&!h.o(M,f)&&Object.defineProperty(M,f,{enumerable:!0,get:p[f]})},o:(M,p)=>Object.prototype.hasOwnProperty.call(M,p)},c={};h.d(c,{default:()=>b});const b={"bars-3":`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
...
</svg>`};return c=c.default})())})},u={};function k(v){var h=u[v];if(h!==void 0)return h.exports;var c=u[v]={exports:{}};return L[v].call(c.exports,c,c.exports,k),c.exports}k.r=v=>{typeof Symbol!="undefined"&&Symbol.toStringTag&&Object.defineProperty(v,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(v,"__esModule",{value:!0})};var y={};return(()=>{function v(l){"@babel/helpers - typeof";return v=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(s){return typeof s}:function(s){return s&&typeof Symbol=="function"&&s.constructor===Symbol&&s!==Symbol.prototype?"symbol":typeof s},v(l)}function h(l){return M(l)||b(l)||z(l)||c()}function c(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function b(l){if(typeof Symbol!="undefined"&&l[Symbol.iterator]!=null||l["@@iterator"]!=null)return Array.from(l)}function M(l){if(Array.isArray(l))return j(l)}function p(l,s){return P(l)||S(l,s)||z(l,s)||f()}function f(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function z(l,s){if(l){if(typeof l=="string")return j(l,s);var o={}.toString.call(l).slice(8,-1);return o==="Object"&&l.constructor&&(o=l.constructor.name),o==="Map"||o==="Set"?Array.from(l):o==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)?j(l,s):void 0}}function j(l,s){(s==null||s>l.length)&&(s=l.length);for(var o=0,t=Array(s);o<s;o++)t[o]=l[o];return t}function S(l,s){var o=l==null?null:typeof Symbol!="undefined"&&l[Symbol.iterator]||l["@@iterator"];if(o!=null){var t,n,r,i,e=[],g=!0,a=!1;try{if(r=(o=o.call(l)).next,s===0){if(Object(o)!==o)return;g=!1}else for(;!(g=(t=r.call(o)).done)&&(e.push(t.value),e.length!==s);g=!0);}catch(w){a=!0,n=w}finally{try{if(!g&&o.return!=null&&(i=o.return(),Object(i)!==i))return}finally{if(a)throw n}}return e}}function P(l){if(Array.isArray(l))return l}function Z(l,s){if(!(l instanceof s))throw new TypeError("Cannot call a class as a function")}function V(l,s){for(var o=0;o<s.length;o++){var t=s[o];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(l,T(t.key),t)}}function _(l,s,o){return s&&V(l.prototype,s),o&&V(l,o),Object.defineProperty(l,"prototype",{writable:!1}),l}function T(l){var s=E(l,"string");return v(s)=="symbol"?s:s+""}function E(l,s){if(v(l)!="object"||!l)return l;var o=l[Symbol.toPrimitive];if(o!==void 0){var t=o.call(l,s||"default");if(v(t)!="object")return t;throw new TypeError("@@toPrimitive must return a primitive value.")}return(s==="string"?String:Number)(l)}var x=k(64),q=(function(){function l(){Z(this,l),this.stores=new Map,this.colors={primary:"#007bff",secondary:"#dc3545"},this.products=[],this.filteredProducts=[],this.sortState={field:"name",direction:"asc"},this.currency={code:"USD",symbol:"$"},this.init(),this.checkoutConfig=new Map}return _(l,[{key:"init",value:function(){this.initializeCatalogs(),this.initializeIndependentButtons(),this.setupEventListeners(),this.updateCustomProperties()}},{key:"initializeStore",value:function(o){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};return this.stores.has(o)||this.stores.set(o,{cart:this.loadCartFromStorage(o),info:{name:t.name||o,whatsapp:t.whatsapp||"",cartEnabled:t.cartEnabled!==!1,floatingCart:t.floatingCart||!1,checkoutTitle:t.checkoutTitle||"Your Cart",billingTitle:t.billingTitle||"Billing Details",submitButtonText:t.submitButtonText||"Proceed to WhatsApp",enableBilling:t.enableBilling!==!1,customFields:t.customFields||[]},products:[],filteredProducts:[],sortState:{field:"name",direction:"asc"}}),this.stores.get(o)}},{key:"loadCartFromStorage",value:function(o){var t="swb-cart-".concat(o),n=localStorage.getItem(t);if(n)try{return JSON.parse(n)}catch(r){localStorage.removeItem(t)}return[]}},{key:"saveCartToStorage",value:function(o,t){var n="swb-cart-".concat(o);localStorage.setItem(n,JSON.stringify(t))}},{key:"clearCart",value:function(o){var t=this.stores.get(o);t&&(t.cart=[],this.saveCartToStorage(o,t.cart),this.updateCartCount(o),this.renderCart(o),this.closeCheckout(o))}},{key:"updateCustomProperties",value:function(){document.documentElement.style.setProperty("--swb-color-primary",this.colors.primary),document.documentElement.style.setProperty("--swb-color-secondary",this.colors.secondary);var o=this.hexToRGB(this.colors.primary),t=this.hexToRGB(this.colors.secondary);document.documentElement.style.setProperty("--swb-color-primary-rgb",o),document.documentElement.style.setProperty("--swb-color-secondary-rgb",t)}},{key:"hexToRGB",value:function(o){var t=parseInt(o.slice(1,3),16),n=parseInt(o.slice(3,5),16),r=parseInt(o.slice(5,7),16);return"".concat(t,", ").concat(n,", ").concat(r)}},{key:"initializeCatalogs",value:function(){var o=this,t=document.querySelectorAll("[data-swb-catalog]");t.forEach(function(n){var r=n.getAttribute("data-swb-store-id");if(r){var i=[];try{var e=n.getAttribute("data-swb-custom-fields");e&&(i=JSON.parse(e))}catch(d){console.warn("Invalid custom fields format",d)}o.initializeStore(r,{name:n.getAttribute("data-swb-store"),whatsapp:n.getAttribute("data-swb-whatsapp"),floatingCart:n.hasAttribute("data-swb-cart-floating")?n.getAttribute("data-swb-cart-floating"):!1,cartEnabled:n.getAttribute("data-swb-cart")!=="false",checkoutTitle:n.getAttribute("data-swb-checkout-title")||"Your Cart",billingTitle:n.getAttribute("data-swb-billing-title")||"Billing Details",submitButtonText:n.getAttribute("data-swb-submit-text")||"Proceed to WhatsApp",enableBilling:n.getAttribute("data-swb-enable-billing")!=="false",customFields:i});var g=n.getAttribute("data-swb-color-primary"),a=n.getAttribute("data-swb-color-secondary");g&&(o.colors.primary=g),a&&(o.colors.secondary=a);var w=n.getAttribute("data-swb-currency");w&&o.setCurrency(w),o.createCatalogHeader(n,r),o.initializeCatalogProducts(n,r)}})}},{key:"initializeIndependentButtons",value:function(){var o=this;document.querySelectorAll("[data-swb-cart][data-swb-store-id]").forEach(function(t){if(!t.hasAttribute("data-swb-catalog")){var n=t.getAttribute("data-swb-store-id");o.initializeStore(n,{name:t.getAttribute("data-swb-store"),whatsapp:t.getAttribute("data-swb-whatsapp"),cartEnabled:!0,floatingCart:!1});var r=t.getAttribute("data-swb-color-primary"),i=t.getAttribute("data-swb-color-secondary");r&&(o.colors.primary=r),i&&(o.colors.secondary=i);var e=t.getAttribute("data-swb-currency");e&&o.setCurrency(e),t.addEventListener("click",function(){o.showCheckout(n)});var g=t.querySelector("[data-swb-cart-count]");g&&o.updateCartCount(n)}}),document.querySelectorAll("[data-swb-product-sku][data-swb-store-id]").forEach(function(t){if(!t.hasAttribute("data-swb-catalog")){var n=t.getAttribute("data-swb-store-id"),r=t.getAttribute("data-swb-product-sku"),i=o.stores.get(n);if(!i){console.warn("Store ".concat(n," not initialized. Make sure you have a cart button with store information."));return}t.addEventListener("click",function(){var e={sku:r,name:t.getAttribute("data-swb-product-name")||r,price:parseFloat(t.getAttribute("data-swb-product-price"))||0,quantity:1};o.addToCart(n,e)})}})}},{key:"setCurrency",value:function(o){var t={USD:{code:"USD",symbol:"$"},EUR:{code:"EUR",symbol:"\u20AC"},GBP:{code:"GBP",symbol:"\xA3"},JPY:{code:"JPY",symbol:"\xA5"},CNY:{code:"CNY",symbol:"\xA5"},MYR:{code:"MYR",symbol:"RM"},SGD:{code:"SGD",symbol:"S$"},AUD:{code:"AUD",symbol:"A$"},CAD:{code:"CAD",symbol:"C$"},INR:{code:"INR",symbol:"\u20B9"},KRW:{code:"KRW",symbol:"\u20A9"},THB:{code:"THB",symbol:"\u0E3F"},PHP:{code:"PHP",symbol:"\u20B1"},IDR:{code:"IDR",symbol:"Rp"},VND:{code:"VND",symbol:"\u20AB"}};t[o]&&(this.currency=t[o])}},{key:"formatPrice",value:function(o){return"".concat(this.currency.symbol).concat(o.toFixed(2))}},{key:"createCatalogHeader",value:function(o,t){var n=this,r=document.createElement("div");r.classList.add("swb-catalog-header");var i=document.createElement("input");i.type="text",i.placeholder="Search products...",i.classList.add("swb-search-input"),i.addEventListener("input",function(m){return n.handleSearch(m.target.value,t)});var e=document.createElement("select");e.classList.add("swb-sort-select"),e.innerHTML=`
            <option value="name-asc">Name (A to Z)</option>
            <option value="name-desc">Name (Z to A)</option>
            <option value="price-asc">Price (Low to High)</option>
            <option value="price-desc">Price (High to Low)</option>
        `,e.addEventListener("change",function(m){var B=m.target.value.split("-"),H=p(B,2),D=H[0],R=H[1];n.handleSort(D,R,t)});var g=document.createElement("div");g.classList.add("swb-catalog-header-control"),g.appendChild(e);var a=this.stores.get(t),w=a.cart.reduce(function(m,B){return m+B.quantity},0);if(a.info.cartEnabled){var d=document.createElement("button");d.classList.add("swb-cart-button"),a.info.floatingCart==="true"&&d.classList.add("swb-cart-button-floating"),d.innerHTML=`
                `.concat(x["shopping-cart"],`
                <span class="swb-cart-count" data-swb-cart-count>`).concat(w,`</span>
            `),d.addEventListener("click",function(){return n.showCheckout(t)}),g.appendChild(d)}r.appendChild(i),r.appendChild(g),o.insertBefore(r,o.firstChild)}},{key:"initializeCatalogProducts",value:function(o,t){var n=this,r=this.stores.get(t);if(r){var i=o.querySelectorAll("[data-swb-product]");r.products=Array.from(i).map(function(e){return{element:e,sku:e.getAttribute("data-swb-product-sku"),name:e.getAttribute("data-swb-product-name"),price:parseFloat(e.getAttribute("data-swb-product-price"))}}),r.filteredProducts=h(r.products),r.products.forEach(function(e){n.initializeProduct(e.element,t)})}}},{key:"initializeProduct",value:function(o,t){var n=this,r=o.querySelector("[data-swb-product-buttons]");if(r){var i=o.getAttribute("data-swb-product-link"),e=o.getAttribute("data-swb-product-link-title");if(i&&e){var g=document.createElement("a");g.href=i,g.target="_blank",g.rel="noopener noreferrer",g.classList.add("swb-external-link"),g.innerHTML="<span>".concat(e,"</span>"),r.appendChild(g)}var a=this.stores.get(t);if(a&&a.info.cartEnabled){var w=o.getAttribute("data-swb-product-add-cart-title"),d=document.createElement("button");d.textContent=w||"Add to Cart",d.classList.add("swb-add-to-cart"),d.onclick=function(){var m={sku:o.getAttribute("data-swb-product-sku"),name:o.getAttribute("data-swb-product-name"),price:parseFloat(o.getAttribute("data-swb-product-price")),quantity:1};n.addToCart(t,m)},r.appendChild(d)}}}},{key:"handleSearch",value:function(o,t){var n=this.stores.get(t);n&&(o=o.toLowerCase(),n.filteredProducts=n.products.filter(function(r){return r.name.toLowerCase().includes(o)||r.sku.toLowerCase().includes(o)}),this.updateProductDisplay(t))}},{key:"handleSort",value:function(o,t,n){var r=this.stores.get(n);if(r){r.sortState.field=o,r.sortState.direction=t;var i=h(r.filteredProducts);i.sort(function(e,g){var a,w;return o==="price"?(a=e.price,w=g.price):(a=e.name.toLowerCase(),w=g.name.toLowerCase()),o==="price"?t==="asc"?a-w:w-a:t==="asc"?a.localeCompare(w):w.localeCompare(a)}),r.filteredProducts=i,this.updateProductDisplay(n)}}},{key:"updateProductDisplay",value:function(o){var t=this.stores.get(o);if(t){var n=document.querySelector('[data-swb-catalog][data-swb-store-id="'.concat(o,'"]'));if(n){var r=n.querySelector(".swb-grid");r&&(Array.from(r.children).forEach(function(i){r.removeChild(i)}),t.filteredProducts.forEach(function(i){r.appendChild(i.element)}))}}}},{key:"setupEventListeners",value:function(){var o=this;document.addEventListener("click",function(t){if(t.target.matches(".swb-modal-close")||t.target.closest(".swb-modal-close")){var n=t.target.closest(".swb-cart-modal");if(n){var r=n.getAttribute("data-swb-store-id");o.closeCheckout(r)}}})}},{key:"updateCartCount",value:function(o){var t=this.stores.get(o);if(t){var n=t.cart.reduce(function(i,e){return i+e.quantity},0);document.querySelectorAll('[data-swb-store-id="'.concat(o,'"] [data-swb-cart-count]')).forEach(function(i){i.textContent=n});var r=document.querySelectorAll('.swb-cart-modal[data-swb-store-id="'.concat(o,'"] .swb-cart-count'));r.forEach(function(i){i.closest(".swb-cart-subheader")?i.textContent=t.cart.length:i.textContent=n})}}},{key:"addToCart",value:function(o,t){var n=this.stores.get(o);if(n){var r=n.cart.find(function(i){return i.sku===t.sku});r?r.quantity++:n.cart.push(t),this.saveCartToStorage(o,n.cart),this.updateCartCount(o),this.renderCart(o)}}},{key:"renderCart",value:function(o){var t=this,n=document.querySelector('.swb-cart-modal[data-swb-store-id="'.concat(o,'"]'));if(n){var r=this.stores.get(o);if(r){var i=n.querySelector(".swb-cart-items");i.innerHTML="",r.cart.forEach(function(e){var g=document.createElement("div");g.classList.add("swb-cart-item"),g.innerHTML=`
                <div class="swb-item-name">`.concat(e.name,`</div>
                <div class="swb-item-quantity">
                    <button onclick="swb.updateQuantity('`).concat(o,"', '").concat(e.sku,`', -1)">
                        `).concat(x.minus,`
                    </button>
                ...
                <div class="swb-item-price">`).concat(e.price?t.formatPrice(e.price*e.quantity):"",`</div>
                <button onclick="swb.removeFromCart('`).concat(o,"', '").concat(e.sku,`')" class="swb-remove-item">
                    `).concat(x["x-mark"],`
                </button>
            `),i.appendChild(g)}),this.updateTotal(o)}}}},{key:"updateQuantity",value:function(o,t,n){var r=this.stores.get(o);if(r){var i=r.cart.find(function(e){return e.sku===t});i&&(i.quantity+=n,i.quantity<=0?this.removeFromCart(o,t):(this.saveCartToStorage(o,r.cart),this.renderCart(o),this.updateCartCount(o)))}}},{key:"removeFromCart",value:function(o,t){var n=this.stores.get(o);n&&(n.cart=n.cart.filter(function(r){return r.sku!==t}),this.updateTotal(o),this.saveCartToStorage(o,n.cart),this.renderCart(o),this.updateCartCount(o))}},{key:"updateTotal",value:function(o){var t=this.stores.get(o);if(t){var n=t.cart.reduce(function(i,e){return i+e.price?e.price*e.quantity:0},0),r=document.querySelector('.swb-cart-modal[data-swb-store-id="'.concat(o,'"] .swb-cart-total'));r&&(r.textContent="Total: ".concat(this.formatPrice(n)))}}},{key:"showCheckout",value:function(o){var t=this,n=this.stores.get(o);if(!n||n.cart.length===0){alert("Your cart is empty");return}var r=document.querySelector('.swb-cart-modal[data-swb-store-id="'.concat(o,'"]'));if(!r){r=document.createElement("div"),r.classList.add("swb-cart-modal"),r.setAttribute("data-swb-store-id",o);var i=n.info.customFields.map(function(a){return`
            ...
            `),document.body.appendChild(r);var e=r.querySelector(".swb-checkout-form");e&&(e.onsubmit=function(a){a.preventDefault(),t.processCheckout(o,new FormData(e))});var g=r.querySelector(".swb-clear-cart");g.onclick=function(){confirm("Are you sure you want to clear your cart?")&&t.clearCart(o)}}this.renderCart(o),this.updateCartCount(o),r.style.display="block"}},{key:"closeCheckout",value:function(o){var t=document.querySelector('.swb-cart-modal[data-swb-store-id="'.concat(o,'"]'));t&&(t.style.display="none")}},{key:"processCheckout",value:function(o,t){var n=this.stores.get(o);if(n){var r={};t.forEach(function(g,a){r[a]=g});var i=this.formatWhatsAppMessage(o,r),e="https://wa.me/".concat(n.info.whatsapp,"?text=").concat(encodeURIComponent(i));window.open(e,"_blank"),this.clearCart(o)}}},{key:"formatWhatsAppMessage",value:function(o,t){var n=this,r=this.stores.get(o);if(!r)return"";var i=new Date().toLocaleString(),e="New Order from ".concat(r.info.name,`
`);e+="Date: ".concat(i,`

`),r.info.enableBilling&&(e+=`Customer Information:
`,e+="Name: ".concat(t.name,`
`),e+="Email: ".concat(t.email,`
`),e+="Phone: ".concat(t.phone,`
`),e+="Address: ".concat(t.address,`

`)),r.info.customFields.forEach(function(a){t[a.name]&&(e+="".concat(a.label||a.name,": ").concat(t[a.name],`
`))}),e+=`Order Details:
`,r.cart.forEach(function(a){e+="- ".concat(a.name," (SKU: ").concat(a.sku,`)
`),e+="  Quantity: ".concat(a.quantity,`
`),a.price&&(e+="  Price: ".concat(n.formatPrice(a.price*a.quantity),`

`))});var g=r.cart.reduce(function(a,w){return a+w.price?w.price*w.quantity:0},0);return g>0&&(e+="Total Amount: ".concat(this.formatPrice(g))),e}}])})();window.swb=new q})(),(()=>{"use strict";k.r(y)})(),y})())});N();})();
